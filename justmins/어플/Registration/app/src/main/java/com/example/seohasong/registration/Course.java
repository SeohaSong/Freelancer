...
/**
 * Created by seohasong on 2018-01-30.
 */
...
public class Course {
    ...
    public Course(int courseID, String courseGrade, String courseTitle, String courseDivide, int coursePersonnel, int courseRival) {
        this.courseID = courseID;
        this.courseGrade = courseGrade;
        this.courseTitle = courseTitle;
        this.courseDivide = courseDivide;
    ...
    public Course(int courseID, String courseGrade, String courseTitle, String courseDivide, int coursePersonnel, int courseRival, int courseCredit) {
        this.courseID = courseID;
        this.courseGrade = courseGrade;
        this.courseTitle = courseTitle;
        this.courseDivide = courseDivide;
    ...
    public Course(int courseID, String courseGrade, String courseTitle, int courseCredit, String courseDivide, int coursePersonnel, String courseTime, String courseProfessor) {
        this.courseID = courseID;
        this.courseGrade = courseGrade;
        this.courseTitle = courseTitle;
        this.courseCredit = courseCredit;
    ...
    public Course(int courseID, String courseUniversity, int courseYear, String courseTerm, String courseArea, String courseMajor, String courseGrade, String courseTitle, int courseCredit, String courseDivide, int coursePersonnel, String courseProfessor, String courseTime, String courseRoom) {
        this.courseID = courseID;
        this.courseUniversity = courseUniversity;
        this.courseYear = courseYear;
        this.courseTerm = courseTerm;
